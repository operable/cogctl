defmodule Cogctl.Optparse do
  ...
  @valid_actions [Cogctl.Actions.Bootstrap,
                  ...
                  Cogctl.Actions.Bundle.Install,
                  Cogctl.Actions.Bundle.Uninstall,
                  Cogctl.Actions.Bundle.Enable,
                  Cogctl.Actions.Bundle.Disable,
                  Cogctl.Actions.Bundle.DynamicConfig,
                  Cogctl.Actions.Bundle.DynamicConfig.Create,
                  Cogctl.Actions.Bundle.DynamicConfig.Delete,
                  Cogctl.Actions.Bundle.DynamicConfig.Info,
